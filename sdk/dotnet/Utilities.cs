...
namespace Pulumi.Productionapp
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Productionapp.version.txt");
    ...
    internal sealed class ProductionappResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public ProductionappResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
